"""
Test script with REAL credit card - HK with 3 months of 20 ILS
...
async def test_real_credit_card_20():
    """Test with real credit card - HK with 3 months of 20 ILS"""
    
    print("=" * 80)
    print("TEST: REAL CREDIT CARD - HK with 3 months of 20 ILS")
    ...
    # Test case - HK with 3 months of 20 ILS
    test_case = {
        "name": "HK - 3 חודשים של ₪20 (סה\"כ ₪60)",
        "payment_type": "HK",
        "monthly_amount": 20.0,
        "months": 3,
        "total_expected": 60.0,
    ...
    try:
        result = await service.charge_card(
            ...
            expiry=expiry,
            cvv=cvv,
            amount=test_case['monthly_amount'],  # Monthly amount: 20 ILS
...
if __name__ == "__main__":
    asyncio.run(test_real_credit_card_20())
