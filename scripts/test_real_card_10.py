"""
Test script with REAL credit card - HK with 3 months of 10 ILS
...
async def test_real_credit_card_10():
    """Test with real credit card - HK with 3 months of 10 ILS"""
    
    print("=" * 80)
    print("TEST: REAL CREDIT CARD - HK with 3 months of 10 ILS")
    ...
    # Test case - HK with 3 months of 10 ILS
    test_case = {
        "name": "HK - 3 חודשים של ₪10 (סה\"כ ₪30)",
        "payment_type": "HK",
        "monthly_amount": 10.0,
        "months": 3,
        "total_expected": 30.0,
    ...
    try:
        result = await service.charge_card(
            client_name="Test User - Real Card 10 ILS",
...
if __name__ == "__main__":
    asyncio.run(test_real_credit_card_10())
