...
**תאריך**: 8 בדצמבר 2025  
**עדכון אחרון**: 15 פברואר 2026  
**סטטוס**: ✅ מיושם חלקית - DebitCard API פעיל

---

## 🔗 דוקומנטציה רשמית

**קישור לדוקומנטציה המקורית של נדרים פלוס:**  
https://matara.pro/nedarimplus/ApiDocumentation.html?v=61

**תיעוד מפורט של DebitCard API:**  
ראה `docs/NEDARIM_DEBITCARD_API.md`
