...
export function LeadsPage() {
  ...
  const columns: SmartColumn<Lead>[] = useMemo(() => [
    ...
    // Additional DB fields - hidden by default but available for filtering
    {
      key: 'address',
      header: 'כתובת',
      type: 'text',
    ...
    },
    {
      ...
      header: 'תאריך שיחה אחרון',
      type: 'datetime',
      hiddenByDefault: true,
      editable: false,
      renderView: r => r.last_contact_date ? formatDate(r.last_contact_date) : '—',
    },
    {
      key: 'discount_notes',
      header: 'הערות הנחה',
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'חתימה דיגיטלית', label: 'חתימה דיגיטלית' },
        { value: 'SMS', label: 'SMS' },
      ],
    },
    {
      key: 'approval_date',
      header: 'תאריך אישור תקנון',
      type: 'datetime',
      hiddenByDefault: true,
      editable: false,
      renderView: r => r.approval_date ? formatDate(r.approval_date) : '—',
    },
    {
      key: 'interested_track_id',
      header: 'מסלול מעוניין',
      type: 'number',
      hiddenByDefault: true,
      editable: false,
    },
    ...
    {
      key: 'selected_payments_count',
      header: 'מספר תשלומים נבחר',
      type: 'number',
      hiddenByDefault: true,
      editable: false,
    },
    {
      key: 'selected_payment_day',
      header: 'יום תשלום נבחר',
      type: 'number',
      hiddenByDefault: true,
      editable: false,
    },
    {
      key: 'first_payment_id',
      header: 'תשלום ראשון',
      type: 'number',
      hiddenByDefault: true,
      editable: false,
    ...
    {
      key: 'nedarim_payment_link',
      header: 'קישור תשלום נדרים',
      type: 'text',
      hiddenByDefault: true,
      editable: false,
      renderView: r => r.nedarim_payment_link ? <a href={r.nedarim_payment_link} target="_blank" rel="noopener noreferrer">קישור</a> : '—',
    },
    {
    ...
    {
      key: 'payment_completed_date',
      header: 'תאריך סליקה',
      type: 'datetime',
      hiddenByDefault: true,
      editable: false,
      renderView: r => r.payment_completed_date ? formatDate(r.payment_completed_date) : '—',
    },
    {
      key: 'payment_completed_method',
      header: 'שיטת סליקה',
      type: 'select',
      hiddenByDefault: true,
      editable: false,
    ...
    {
      key: 'kinyan_signed_date',
      header: 'תאריך חתימת קניין',
      type: 'datetime',
      hiddenByDefault: true,
      editable: false,
      renderView: r => r.kinyan_signed_date ? formatDate(r.kinyan_signed_date) : '—',
    },
    {
      key: 'kinyan_method',
      header: 'שיטת קניין',
      ...
      editable: false,
      options: [
        { value: 'PDF במייל', label: 'PDF במייל' },
        { value: 'אישור טלפוני', label: 'אישור טלפוני' },
        { value: 'IVR', label: 'IVR' },
        { value: 'חתימה דיגיטלית', label: 'חתימה דיגיטלית' },
      ],
    },
    {
      ...
      hiddenByDefault: true,
      editable: false,
      renderView: r => r.kinyan_file_url ? <a href={r.kinyan_file_url} target="_blank" rel="noopener noreferrer">קובץ</a> : '—',
    },
    {
      key: 'kinyan_notes',
      header: 'הערות קניין',
    ...
    {
      key: 'shipping_details_complete',
      header: 'פרטי משלוח מלאים',
      type: 'select',
      hiddenByDefault: true,
      editable: false,
      options: [
    ...
    {
      key: 'student_chat_added',
      header: 'צ\'אט תלמיד הוסף',
      type: 'select',
      hiddenByDefault: true,
      editable: false,
      options: [
    ...
    {
      key: 'student_chat_link',
      header: 'קישור צ\'אט',
      type: 'text',
      hiddenByDefault: true,
      editable: false,
      renderView: r => r.student_chat_link ? <a href={r.student_chat_link} target="_blank" rel="noopener noreferrer">קישור</a> : '—',
    },
    {
      key: 'student_chat_platform',
      header: 'פלטפורמת צ\'אט',
      type: 'select',
      hiddenByDefault: true,
      editable: false,
      options: [
    ...
    {
      key: 'student_chat_added_date',
      header: 'תאריך הוספת צ\'אט',
      type: 'datetime',
      hiddenByDefault: true,
      editable: false,
      renderView: r => r.student_chat_added_date ? formatDate(r.student_chat_added_date) : '—',
    },
    {
      key: 'personal_course_update',
      header: 'עדכון אישי קורס',
      type: 'select',
      hiddenByDefault: true,
      editable: false,
      options: [
    ...
    {
      key: 'personal_course_update_date',
      header: 'תאריך עדכון אישי',
      type: 'datetime',
      hiddenByDefault: true,
      editable: false,
      renderView: r => r.personal_course_update_date ? formatDate(r.personal_course_update_date) : '—',
    },
    {
      key: 'personal_course_update_notes',
      header: 'הערות עדכון אישי',
      type: 'text',
      hiddenByDefault: true,
      editable: false,
    },
    {
      key: 'handoff_to_manager',
      header: 'הועבר למנהל',
      type: 'select',
      hiddenByDefault: true,
      editable: false,
    ...
    },
    {
      ...
      hiddenByDefault: true,
      editable: false,
      renderView: r => r.handoff_date ? formatDate(r.handoff_date) : '—',
    },
    {
      key: 'handoff_manager_id',
      header: 'מנהל הכיתות',
      type: 'number',
      hiddenByDefault: true,
      editable: false,
    ...
    {
      key: 'handoff_completed_date',
      header: 'תאריך השלמת העברה',
      type: 'datetime',
      hiddenByDefault: true,
      editable: false,
      renderView: r => r.handoff_completed_date ? formatDate(r.handoff_completed_date) : '—',
    },
    {
      key: 'conversion_checklist_complete',
      header: 'רשימת המרה מלאה',
      type: 'select',
      hiddenByDefault: true,
      editable: false,
      options: [
    ...
    {
      key: 'conversion_completed_at',
      header: 'תאריך השלמת המרה',
      type: 'datetime',
      hiddenByDefault: true,
      editable: false,
      renderView: r => r.conversion_completed_at ? formatDate(r.conversion_completed_at) : '—',
    },
    {
      key: 'conversion_completed_by_id',
      header: 'הושלם ע"י',
      type: 'number',
      hiddenByDefault: true,
      editable: false,
